...
public class DateUtil {
    ...
    public static void main(String[] args) {
        Map<ProNextEnum, Date> previousAndNextMaxDate = getPreviousAndNextMaxDate();
        Collection<Date> values = previousAndNextMaxDate.values();
        values.forEach(e -> System.out.println(getDateTime(e)));
    }
